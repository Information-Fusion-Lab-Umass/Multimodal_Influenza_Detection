...
if __name__ == '__main__':
  ...
  if args.dataset == "pascal_voc":
      ...
      args.imdb_name = "OSU_train-all02"
      args.imdbval_name = "OSU_test-all02"#change here
      args.set_cfgs = ['ANCHOR_SCALES', '[0.05, 0.1, 0.25, 0.5]', 'ANCHOR_RATIOS', '[0.5,1,2]', 'MAX_NUM_GT_BOXES', '30']#scales=[4,8,16,32]--d 
  ...
  for i in range(num_images):
	  ...
	  #pdb.set_trace()
          cv2.imwrite('visualize_test/result'+str(i)+'.png', im2show)
          #pdb.set_trace()
