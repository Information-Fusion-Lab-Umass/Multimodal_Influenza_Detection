...
if __name__ == '__main__':
  ...
  if args.dataset == "pascal_voc":
      ...
      args.imdbval_name = "test_night_salient_ir"#"test_combined_salient_ir"#change here
  ...
  #det_file = "/home/dghose/Project/detections.pkl"
  ...
  for i in range(num_images):
	  ...
	  #pdb.set_trace()
          cv2.imwrite('visualize_day/result'+str(i)+'.png', im2show)
          #pdb.set_trace()
